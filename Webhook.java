package hu.coma.webhook.discordwebhook.hook;
...
public class Webhook {
    ...
    public static class EmbedObject {
        ...
        private class Footer {
            ...
            private Footer(@NotNull String text, @NotNull String iconUrl) {
                this.text = text;
        ...
        private class Thumbnail {
            ...
            private Thumbnail(@NotNull String url) {
                this.url = url;
            }
        ...
        private class Image {
            ...
            private Image(@NotNull String url) {
                this.url = url;
            }
        ...
        private class Author {
            ...
            private Author(@NotNull String name, @NotNull String url, @NotNull String iconUrl) {
                this.name = name;
                this.url = url;
                this.iconUrl = iconUrl;
            }
